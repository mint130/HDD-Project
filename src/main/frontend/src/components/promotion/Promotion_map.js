...
const Promotion_map = ({onClick}) => {
  ...
  return (
      ...
      >
        ...
        <Rect as="rect" x={733} y={176} width={29} height={78} isClicked={clicked === "D"} id="D"/>
        <Rect as="rect" x={372} y={227} width={108} height={35} isClicked={clicked === "MH"} id="MH"/>
        <Rect as="rect"
              x={500.872}
              y={395.79}
              width={35}
              ...
              id="T"
        />
        <Rect as="rect" x={459} y={344} width={57} height={33} isClicked={clicked === "S"} id="S" />
        <Rect as="rect" x={389} y={303} width={109} height={26} isClicked={clicked === "Z1"} id="Z1"/>
        <Rect as="rect" x={480} y={139} width={46} height={41} isClicked={clicked === "U"} id="U"/>
        <Rect as="rect" x={498} y={236} width={175} height={26} isClicked={clicked === "A"} id="A"/>
        <Rect as="rect" x={516} y={182} width={25} height={89} fisClicked={clicked === "B"} id="B"/>
        <Rect as="rect"
              x={174.362}
              y={157}
              width={38.6138}
        ...
        <Path
            ...
            isClicked={clicked === "J"}
        />
        <Rect as="rect" x={445} y={189} width={61} height={33} isClicked={clicked === "E"} id="E"/>
        <Path
            id="Q"
